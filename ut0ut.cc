...
UNIV_INLINE ulint ut_ulint_cmp(ulint a, ulint b)
{
	if(a < b)
		return -1;
	else if(a == b)
...
UNIV_INLINE ulint ut_pair_cmp(ulint a1, ulint b1, ulint a2, ulint b2)
{
	if(a1 > b1)
		return 1;
	else if(a1 < b1)
...
UNIV_INLINE ulint ut_2_power_up(ulint n)
{
	ulint ret = 1;
